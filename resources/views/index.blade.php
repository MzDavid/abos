                              ...
                              <div class="main-menu-area">
                                  <nav>
                                      <ul>
                                          ...
                                          <li><a href="practice.html">Áreas de Práctica</a>
                                            <ul class="text-center">
                                                <li><a href="single-practice.html">Civil</a></li>                                                
                                                <li><a href="single-practice-left-sidebar.html">Amparo</a></li>
                                                <li><a href="single-practice.html">Familiar</a></li>
                                                <li><a href="single-practice.html">Laboral</a></li>
                                                <li><a href="single-practice.html">Notarial</a></li>
                                            </ul>
                                          </li>
                                          <li><a href="awards.html">Reconocimientos</a></li>
                    ...
                    <nav id="dropdown">
                      <ul>
                        ...
                        <li><a href="practice.html">Áreas de Práctica</a>
                          <ul>
                              <li><a href="single-practice.html">Civil</a></li>
                              <li><a href="single-practice.html">Amparo</a></li>
                              <li><a href="single-practice.html">Familiar</a></li>
                              <li><a href="single-practice.html">Laboral</a></li>
                              <li><a href="single-practice.html">Notarial</a></li>
                          </ul>
                  ...
                  <div class="slider-content t-lfr s-tb slider-2">
                    <div class="title-container s-tb-c">
                      ...
                      <div style="visibility: visible; animation-duration: 4s; animation-delay: 0.4s;" class="button wow fadeIn" data-wow-duration="4s" data-wow-delay="0.4s">
                        <a class="btn btn-success" href="#">Contactanos</a>
                        </div>                     
                    </div>
                  </div>  
                </div>
